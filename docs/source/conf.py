# -*- coding: utf-8 -*-
#
# sanhe_atlassian_sdk documentation build configuration file, created by
...
import sanhe_atlassian_sdk as package
...
# Add data for Jinja2
try:
    from sanhe_atlassian_sdk.docs import doc_data
except:
    doc_data = dict()
